...
AForm::AForm(std::string target, std::string form, int gradeToSign, int gradeToExecute)
		: _target(target), _form(form), _gradeToSign(gradeToSign), _gradeToExecute(gradeToExecute) {
	_signed = false;
